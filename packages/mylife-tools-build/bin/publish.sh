...
docker build --pull -t "vincenttr/$package_name:$package_version" -t "vincenttr/$package_name:latest" -f "$(dirname $(realpath ${BASH_SOURCE}))/../docker/Dockerfile" .
docker push "vincenttr/$package_name:$package_version"
docker push "vincenttr/$package_name:latest"
