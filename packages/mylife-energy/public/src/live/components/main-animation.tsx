import { React, mui, useSelector, clsx, useScreenPhone } from 'mylife-tools-ui';
...
const ArrowTopToRight: React.FunctionComponent = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 118.047 110.756">
    <g id="pv_to_consume_1_" data-name="pv to consume (1)" transform="translate(0 22)">
      <rect id="container" width="106.046" height="110.756" transform="translate(0 -22)" fill="rgba(255,83,83,0.11)" opacity="0"></rect>
      <g id="pointer-solar-home" transform="translate(0 -7)">
        <circle id="Oval_Copy_8" cx="6.916" cy="6.916" r="5" fill="#01b4de" opacity="0.2"></circle>
        <circle id="Oval_Copy_9" cx="2.305" cy="2.305" r="2" transform="translate(4.611 4.611)" fill="#01b4de"></circle>
      </g>
      <g id="P_C" transform="translate(6.916)">
        <path id="Arrow_head" d="M86.611,71.575a.461.461,0,0,1-.1.288l-3.953,4.255a.3.3,0,0,1-.361.073.392.392,0,0,1-.2-.35v-8.46a.372.372,0,0,1,.2-.346.311.311,0,0,1,.36.058l3.953,4.2a.424.424,0,0,1,.1.282Z" transform="translate(24.52 10.23)" fill="#01b4de"></path>
        <path id="motion-path-solar-home" d="M0-22V70.313A11.527,11.527,0,0,0,11.527,81.84h97.3" fill="none" stroke="#01b4de" stroke-width="1" fill-rule="evenodd"></path>
      </g>
    </g>
...
const ArrowTopToLeft: React.FunctionComponent = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 118.046 110.756">
    <g id="pv_to_grid" data-name="pv to grid" transform="translate(12 22)">
      ...
      <g id="P_G">
        <path id="motion-path-solar-grid" d="M98.825-22V70.313A11.527,11.527,0,0,1,87.3,81.84H-10" transform="translate(0.305)" fill="none" stroke="#01b4de" stroke-width="1" fill-rule="evenodd"></path>
        <path id="Arrow_head" d="M0,71.575a.461.461,0,0,0,.1.288l3.953,4.255a.3.3,0,0,0,.361.073.392.392,0,0,0,.2-.349v-8.46a.372.372,0,0,0-.2-.346.311.311,0,0,0-.36.06L.1,71.3a.424.424,0,0,0-.1.275Z" transform="translate(-12 10.23)" fill="#01b4de"></path>
      </g>
    </g>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 244.803 13.857">
    <g id="Grid_to_consumption" data-name="Grid to consumption" transform="translate(0.001)">
      <g id="arrow" transform="translate(0.5 2.309)">
        <path id="motion-path-grid-home" data-name="arrow body" d="M58,1.078,299.338.5" transform="translate(-58 3.618)" fill="none" stroke="#6b7073" stroke-width="1"></path>
        <path id="Arrow_head" data-name="Arrow head" d="M4.619,4.583a.458.458,0,0,1-.1.289L.557,9.133A.3.3,0,0,1,.2,9.206.392.392,0,0,1,0,8.856V.382A.373.373,0,0,1,.2.033a.312.312,0,0,1,.361.06L4.516,4.306A.425.425,0,0,1,4.619,4.583Z" transform="translate(239.183 -0.5)" fill="#6b7073"></path>
      </g>
      <g id="pointer-grid-home" transform="translate(-50 13.0) rotate(180)">
        <circle id="Oval_Copy_12" data-name="Oval Copy 12" cx="5" cy="6.928" r="5" fill="#6b7073" opacity="0.2"></circle>
        <circle id="Oval_Copy_13" data-name="Oval Copy 13" cx="2" cy="2.309" r="2" transform="translate(3.119 4.619)" fill="#6b7073"></circle>
      </g>
    </g>
