...
type Configuration = shared.PaypalScraper.Configuration;
type State = shared.PaypalScraper.State;

const EMPTY = {};

interface PaypalScraperConfigProps {
  configuration: unknown;
  onChange?: (configuration: unknown) => void;
}

export const PaypalScraperConfig: React.FunctionComponent<PaypalScraperConfigProps> = ({ configuration: untypedConfig, onChange }) => {
...
interface PaypalScraperStateProps {
  state: unknown;
}

export const PaypalScraperState: React.FunctionComponent<PaypalScraperStateProps> = ({ state }) => {
  return (
    <></>
  );
};
