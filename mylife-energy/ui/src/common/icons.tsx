...
export type IconProps = Omit<React.ComponentProps<typeof SvgIcon>, 'viewBox' | 'children'>;

const Energy = (props: IconProps) => (
...
const DeviceTypeMain = (props: IconProps) => (
...
const DeviceTypeTotal = (props: IconProps) => (
...
const DeviceTypeSolar = (props: IconProps) => (
  <SvgIcon viewBox="0 -960 960 960" {...props}>
